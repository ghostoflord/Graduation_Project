...
public class NotificationController {
    ...
    public ResponseEntity<RestResponse<?>> deleteNotification(@PathVariable Long id) {
        notificationService.deleteNotification(id);

        RestResponse<Object> response = new RestResponse<>();
        response.setStatusCode(HttpStatus.OK.value());
        response.setMessage("Xóa thông báo thành công");
        response.setError(null);
        response.setData(null);
    ...
    @ApiMessage("update notification")
    public ResponseEntity<RestResponse<?>> updateNotification(
        ...
        RestResponse<Object> response = new RestResponse<>();
        response.setStatusCode(HttpStatus.OK.value());
        response.setMessage("Cập nhật thông báo thành công");
        response.setError(null);
        response.setData(null);
